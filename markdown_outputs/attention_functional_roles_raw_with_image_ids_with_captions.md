...
"img_attention_functional_roles_1_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-0.png",
    "page": 1,
    ...
    "caption": "A diagram compares two solutions, Solution A and Solution B, both contained in 20mL round-bottom flasks. Solution A visually depicts five purple particles, while Solution B contains three purple particles, illustrating a comparison of particle concentration within identical volumes.",
    "depicted_concepts": [
      "Solution",
      "Concentration",
      "Volume",
...
"img_attention_functional_roles_1_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-1.png",
    "page": 1,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "illustrates",
    "caption": "A diagram depicts two round-bottom flasks containing solutions with purple circular particles. The flask on the right is labeled \"Volume: 20mL\" and contains \"Solution B\" with fewer particles than the flask on the left.",
    "depicted_concepts": [
      "flask",
      "solution",
      "volume",
...
"img_attention_functional_roles_1_2": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-2.png",
    "page": 1,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "other",
    "semantic_role": "illustrates",
    "caption": "Two round-bottom flasks are depicted, each containing a solution with purple particulate matter. A label indicates 'Volume: 20mL' and 'Solution B', associated with the contents of one of the flasks.",
    "depicted_concepts": [
      "round-bottom flask",
      "solution",
      "particulate matter",
...
"img_attention_functional_roles_1_3": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-3.png",
    "page": 1,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "low",
    "image_type": "other",
    "semantic_role": "decorative",
    "caption": "A decorative cartoon illustration of a person with no direct scientific content.",
    "depicted_concepts": [],
    "confidence": "high"
}
```
...
"img_attention_functional_roles_1_5": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-5.png",
    "page": 1,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "illustrates",
    "caption": "The graphic presents an educational prompt including a question about solvent volume and particle counts in chemical solutions. It features an anatomical diagram of a human brain with the occipital lobe highlighted and labeled, followed by a numerical answer for the solvent volume and particle counts in Solution A and Solution B.",
    "depicted_concepts": [
      "Solvent volume",
      "Particle count",
      "Chemical solution",
...
"img_attention_functional_roles_1_6": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-6.png",
    "page": 1,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "other",
    "semantic_role": "explains",
    "caption": "A composite image featuring a question and answer regarding the calculation of particle concentration in a solution, stating it's done by dividing the number of particles by the solvent volume. The image also includes an anatomical illustration of a human brain with the temporal lobe distinctly highlighted.",
    "depicted_concepts": [
...
"img_attention_functional_roles_1_7": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-7.png",
    "page": 1,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "illustrates",
    "caption": "A simplified diagram illustrates a human brain, with the frontal lobe highlighted in yellow and explicitly labeled as 'Frontal lobe'. Other brain regions are shown in a lighter, uncolored outline.",
    "depicted_concepts": [
      "Human brain",
      "Frontal lobe"
    ],
...
"img_attention_functional_roles_1_4": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-4.png",
    "page": 1,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "other",
    "semantic_role": "illustrates",
    "caption": "The image displays an educational quiz format, presenting a question about which solution has a higher concentration of particles, accompanied by a cartoon illustration of a human brain with the parietal lobe highlighted in green, and the textual answer to the concentration question.",
    "depicted_concepts": [
...
"img_attention_functional_roles_1_8": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-8.png",
    "page": 1,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "low",
    "image_type": "other",
    "semantic_role": "decorative",
    "caption": "A cartoon robot icon labeled 'AI', possibly part of a larger explanatory diagram.",
    "depicted_concepts": [],
    "confidence": "high"
}
```
...
"img_attention_functional_roles_1_11": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-1-11.png",
    "page": 1,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "architecture",
    "semantic_role": "illustrates",
    "caption": "A sequential processing architecture diagram depicts multiple vertical stacks of computational units. Upward arrows indicate local processing within each stack, while colored diagonal lines illustrate long-range dependencies or skip connections from earlier units to later ones. An 'EOL' label is associated with the final yellow unit in the sequence.",
    "depicted_concepts": [
...
"img_attention_functional_roles_5_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-5-0.png",
    "page": 5,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "The image displays eight heatmaps, each depicting a distinct cognitive task, where color intensity signifies a metric's value across 'Head Number' (x-axis, 0-25) and 'Layer Number' (y-axis, 0-25). The tasks include Decision-Making, High-Level Visual Reception, Inference, Language Knowledge Recall, Low-Level Visual Reception, Math Reasoning, Info Under. & Extra, and Vision Knowledge Recall, with the metric ranging from 0.60 to 1.00 as indicated by the color bar.",
    "depicted_concepts": [
      "Heatmap",
      "Head Number",
      "Layer Number",
...
"img_attention_functional_roles_5_1": {
    ...
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "Two heatmaps display correlation matrices between various skill categories for two different models: Qwen2.5-VL-7B-Instruct (left) and InternVL3-8B (right). The matrices show correlation coefficients between 'Decision', 'High-Level', 'Inference', 'Lang Recall', 'Low-Level', 'Math', 'Info', and 'Vision Recall' categories.",
    "depicted_concepts": [
      "Heatmap",
      "Correlation matrix",
...
"img_attention_functional_roles_6_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-6-0.png",
    "page": 6,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "supports_result",
    "caption": "Four line plots illustrate the impact of 'Masked Heads Ratio' on 'Score' across different tasks: Inference, High-Level Visual Reception, Low-Level Visual Reception, and Decision-Making. Each plot compares 'TopK LLM' (blue solid line), 'RandomK LLM' (blue dashed line), 'TopK ACC' (red solid line), and 'RandomK ACC' (red dashed line) metrics as the masked heads ratio increases from 0.00 to 0.25.",
    "depicted_concepts": [
      "Line plot",
      "Masked Heads Ratio",
      "Score",
...
"img_attention_functional_roles_7_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-7-0.png",
    "page": 7,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "supports_result",
    "caption": "Two heatmaps illustrate numerical values representing the interaction between various 'Target Functions' (rows) and 'Intervention Functions' (columns) for two distinct models: Qwen2.5-VL-3B-Instruct (left) and gemma-3n-e2b-it (right). The color intensity, ranging from light to dark blue, corresponds to higher numerical magnitudes, while values are also explicitly displayed within each cell.",
    "depicted_concepts": [
      "Heatmap",
...
"img_attention_functional_roles_13_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-13-0.png",
    "page": 13,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "The image displays eight histograms showing the frequency distribution of token length for various cognitive and language-related tasks. Each subplot presents 'Token Length' on the x-axis and 'Frequency' on the y-axis for tasks including High-Level Vision Reception, Language Knowledge Recall, Inference, Vision Knowledge Recall, Low-Level Vision Reception, Decision-Making, Semantic Understanding, and Math Reasoning.",
    "depicted_concepts": [
      "Histogram",
      "Token Length",
      "Frequency",
...
"img_attention_functional_roles_14_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-14-0.png",
    "page": 14,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "explains",
    "caption": "A grid of eight distinct word clouds visualizes the most prominent terms associated with different cognitive skills. Each word cloud is labeled with a specific skill, including High-Level Vision Reception, Language Knowledge Recall, Inference, Vision Knowledge Recall, Low-Level Vision Reception, Decision-Making, Semantic Understanding, and Math Reasoning, where word size indicates frequency or importance within that category.",
    "depicted_concepts": [
      "word cloud",
      "cognitive skills",
      "High-Level Vision Reception",
...
"img_attention_functional_roles_14_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-14-1.png",
    "page": 14,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "table_image",
    "semantic_role": "supports_result",
    "caption": "A 2x2 contingency table presents the distribution of individuals based on exposure history within Case and Control groups. The Case group contains 400 individuals with a history of exposure and 100 without, totaling 500, while the Control group shows 100 individuals with exposure history and 400 without, also totaling 500.",
    "depicted_concepts": [
      "Contingency table",
      "Case group",
      "Control group",
...
"img_attention_functional_roles_15_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-15-0.png",
    "page": 15,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "other",
    "semantic_role": "illustrates",
    "caption": "A microscopic image displays multiple elongated, rectangular plant cells, characteristic of onion epidermal tissue. Each cell exhibits a distinct cell wall, with smaller, darker blue-stained nuclei visible within the cytoplasm of most cells.",
    "depicted_concepts": [
      "Plant cell",
...
"img_attention_functional_roles_16_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-16-0.png",
    "page": 16,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "The image presents eight heatmaps, each mapping a quantitative metric, indicated by a color scale from 0.60 to 1.00, across 36 'Layer Number' values (y-axis) and 16 'Head Number' values (x-axis). These heatmaps illustrate distinct patterns for cognitive tasks including Decision-Making, High-Level Vision Reception, Inference, Language Knowledge Recall, Low-Level Vision Reception, Math Reasoning, Information Understanding & Extraction, and Vision Knowledge Recall.",
    "depicted_concepts": [
      "Heatmap",
      "Layer number",
      "Head number",
...
"img_attention_functional_roles_17_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-17-0.png",
    "page": 17,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "The image displays eight heatmaps, each representing the distribution of a measured value across 'Layer Number' (y-axis, 0-25) and 'Head Number' (x-axis, 0-12) for distinct cognitive tasks. The color bar indicates values ranging from approximately 0.60 (dark purple) to 1.00 (yellow), illustrating the strength of activation or contribution of specific layers and heads to tasks such as Decision-Making, High-Level Vision Reception, Inference, Language Knowledge Recall, Low-Level Vision Reception, Math Reasoning, Information Understanding & Extra, and Vision Knowledge Recall.",
    "depicted_concepts": [
      "Layer Number",
      "Head Number",
      "Decision-Making",
...
"img_attention_functional_roles_17_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-17-1.png",
    "page": 17,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "A grid of eight heatmaps illustrates the distribution of values across model layers and attention heads for various cognitive tasks. Each heatmap plots 'Layer Number' on the y-axis and 'Head Number' on the x-axis, with color intensity indicating values ranging from 0.60 (dark purple) to 1.00 (bright yellow). The tasks include Decision-Making, High-Level Vision Reception, Inference, Language Knowledge Recall, Low-Level Vision Reception, Math Reasoning, Info Under. & Extra, and Vision Knowledge Recall.",
    "depicted_concepts": [
      "Heatmap",
      "Layer Number",
      "Head Number",
...
"img_attention_functional_roles_18_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-18-0.png",
    "page": 18,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "A grid of eight heatmaps illustrates the distribution of values across model layers and attention heads for various cognitive tasks. Each heatmap plots 'Layer Number' on the y-axis against 'Head Number' on the x-axis, with color intensity indicating value, ranging from 0.60 (dark purple) to 1.00 (yellow), for tasks such as Decision-Making, Inference, Math Reasoning, and different types of vision and language reception/recall.",
    "depicted_concepts": [
      "Heatmap",
      "Layer Number",
      "Head Number",
...
"img_attention_functional_roles_18_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-18-1.png",
    "page": 18,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "A grid of eight heatmaps displays quantitative values across 'Layer Number' (Y-axis, 0-30+) and 'Head Number' (X-axis, 0-7) for various cognitive abilities. Each subplot, titled with an ability like 'Decision-Making' or 'Language Knowledge Recall', uses a color scale from 0.60 (purple) to 1.00 (yellow) to indicate value intensity at specific layer-head intersections.",
    "depicted_concepts": [
      "Heatmap",
      "Layer Number",
      "Head Number",
...
"img_attention_functional_roles_19_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-19-0.png",
    "page": 19,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "other",
    "semantic_role": "defines",
    "caption": "The image displays a text-based prompt template titled 'Generating CoT Prompt' for an expert visual reasoning assistant. This prompt defines the structure for generating a detailed step-by-step Chain of Thought (CoT) reasoning, requiring analysis of an image, breakdown of a problem into logical steps, and conclusion with the correct answer, given a question and a correct answer.",
    "depicted_concepts": [
...
"img_attention_functional_roles_20_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-20-0.png",
    "page": 20,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "explains",
    "caption": "This image displays a prompt for generating subquestions, detailing the inputs (a main question and a chain-of-thought) and providing a set of rules for the subquestion generation task. The prompt specifies that subquestions must be derived from the main query, map to a single cognitive skill, and adhere to a structured JSON output format containing subquestion text, a concise answer, and an assigned cognitive skill.",
    "depicted_concepts": [
      "Prompt engineering",
...
"img_attention_functional_roles_21_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-21-0.png",
    "page": 21,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "defines",
    "caption": "A structured prompt template is depicted, illustrating the input format for a question, prior knowledge in chain-of-thought (CoT) format, and specific instructions for generating a response. The prompt specifies a JSON output format for the final answer, enclosed within square brackets, with a key 'answer' holding the response.",
    "depicted_concepts": [
      "Prompt template",
...
"img_attention_functional_roles_21_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-21-1.png",
    "page": 21,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "table_image",
    "semantic_role": "illustrates",
    "caption": "This image displays an example of Topk Tokens Selection, featuring a visual question-answering scenario. It shows a 'Question', a 'Generated Full Answer', a 'Ground Truth Answer', and the 'Top 5 Tokens Selected' extracted from the answers to illustrate token selection.",
    "depicted_concepts": [
...
"img_attention_functional_roles_21_2": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-21-2.png",
    "page": 21,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "other",
    "semantic_role": "illustrates",
    "caption": "This image provides an example of Topk token selection, showing a Question regarding truck weight estimation, a Generated Full Answer with a specific weight in pounds and kilograms, a Ground Truth Answer in tons, and the Top 5 Tokens Selected from the generated answer.",
    "depicted_concepts": [
      "Topk Tokens Selection",
      "Question Answering",
      "Generated Answer",
...
"img_attention_functional_roles_22_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-22-0.png",
    "page": 22,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "supports_result",
    "caption": "The image presents eight heatmaps, each depicting Pearson correlation coefficients between three different prompt configurations: 'Full Prompt', 'w/o Main Question', and 'w/o CoT'. These correlation matrices are displayed for eight distinct cognitive functions, including Decision-Making, High-Level Vision Reception, Inference, Language Knowledge Recall, Low-Level Vision Reception, Math Reasoning, Semantic Understanding, and Vision Knowledge Recall. A color bar on the right side of each heatmap indicates correlation values ranging from 0.0 to 1.0.",
    "depicted_concepts": [
      "Pearson Correlation",
      "Heatmap",
      "Prompt",
...
"img_attention_functional_roles_23_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-23-0.png",
    "page": 23,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "supports_result",
    "caption": "The image presents eight heatmaps illustrating Pearson Correlation coefficients between different TopK values (Top1, Top3, Top5) for various cognitive functions. Each heatmap depicts a 3x3 correlation matrix for a specific function, including Decision-Making, High-Level Vision Reception, Inference, Language Knowledge Recall, Low-Level Vision Reception, Math Reasoning, Semantic Understanding, and Vision Knowledge Recall, with correlation values ranging from 0.0 to 1.0 represented by a color scale.",
    "depicted_concepts": [
      "Pearson Correlation",
      "TopK",
      "Top1",
...
"img_attention_functional_roles_23_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-23-1.png",
    "page": 23,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "supports_result",
    "caption": "Eight heatmaps display Pearson correlation coefficients between different prompts or models (Llama3.3-70B, GPTS, Qwen3-30B) across eight distinct functions: Decision-Making, High-Level Vision Reception, Inference, Language Knowledge Recall, Low-Level Vision Reception, Math Reasoning, Semantic Understanding, and Vision Knowledge Recall. Each matrix shows correlation values numerically and visually via a color scale ranging from 0.0 to 1.0.",
    "depicted_concepts": [
      "Pearson Correlation",
      "Heatmap",
      "Llama3.3-70B",
...
"img_attention_functional_roles_24_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-24-0.png",
    "page": 24,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "supports_result",
    "caption": "A collection of eight heatmaps displays the Pearson correlation coefficients between different random seeds (seed0, seed100, seed42) for various cognitive functions. Each subplot, corresponding to a specific function like Decision-Making or Inference, uniformly shows a correlation of 1.00 across all seed combinations, indicating perfect correlation.",
    "depicted_concepts": [
      "Pearson Correlation",
      "Random Seed",
      "Decision-Making",
...
"img_attention_functional_roles_25_0": {
    ...
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "A grid of eight correlation matrices displays the relationships between four distinct models (Qwen2.5VL-7B, Qwen2.5VL-3B, Intern3VL-8B, Intern3VL-2B) across various cognitive and visual tasks. Each heatmap quantifies the correlation coefficients for tasks such as Decision-Making, High-Level Vision Reception, Inference, Language Knowledge Recall, Low-Level Vision Reception, Math Reasoning, Information Understanding & Extraction, and Vision Knowledge Recall, with values ranging from approximately -0.15 to 1.00 as indicated by the color bar.",
    "depicted_concepts": [
      "Correlation matrix",
      "Heatmap",
      "Qwen2.5VL-7B model",
...
"img_attention_functional_roles_25_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-25-1.png",
    "page": 25,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "Three heatmaps visualize the importance of Top30 attention heads for various cognitive functions across three different language models: Qwen2.5-VL-3B-Instruct, InternVL3-2B, and gemma-3n-e2b-it. The Y-axis lists functions such as High-Level, Low-Level, Vision Recall, Decision, Inference, Math, Info, and Lang Recall, sorted by average weight. The X-axis represents the Top30 Head Index, with the color intensity (yellow to dark blue) indicating the relative weight or importance of each head for a given function.",
    "depicted_concepts": [
      "Heatmap",
      "Attention heads",
      "Qwen2.5-VL-3B-Instruct model",
...
"img_attention_functional_roles_26_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-26-0.png",
    "page": 26,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "illustrates",
    "caption": "A case study demonstrating a 'Negative Intervention Case' within the CogVisioin (In-Domain) dataset, presenting a natural language query 'Drivers are instructed to stop their vehicles.' and its 'Original Output' as 'Drivers are instructed to stop their vehicles at the 'STOP' sign.' The section for 'After negative Intervention (Semantic Understanding) Output' is a placeholder.",
    "depicted_concepts": [
...
"img_attention_functional_roles_26_2": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-26-2.png",
    "page": 26,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "illustrates",
    "caption": "A \"Negative Intervention Case\" example from the Clevr-Math (Out-of-Domain) dataset, presenting a visual counting query about purple matte cylinders. The diagram shows the query, a ground truth answer, an original output with reasoning, and an \"After negative Intervention (Math Reasoning) Output\" with its reasoning, alongside a 3D rendering of multiple geometric objects including purple cylinders, a green sphere, a blue sphere, and a light blue cube.",
    "depicted_concepts": [
...
"img_attention_functional_roles_26_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-26-1.png",
    "page": 26,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "other",
    "semantic_role": "illustrates",
    "caption": "The image depicts a 3D rendered scene featuring various geometric primitives on a light grey plane under illumination. Objects include a metallic blue sphere, a diffuse green sphere, a diffuse blue cube, and four purple cylinders, one of which exhibits a metallic sheen while the others appear diffuse.",
    "depicted_concepts": [
      "3D rendering",
...
"img_attention_functional_roles_27_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-27-1.png",
    "page": 27,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "illustrates",
    "caption": "This figure presents a Negative Intervention Case, illustrating a model's response to an out-of-domain query from the okvqa dataset. It details the Ground Truth Answer, the Original Output with reasoning, and the output After Negative Intervention (High-Level Visual Reception) for a query regarding food choice. The visual component displays a red bowl containing soup with vegetables alongside a toasted sandwich on a white plate.",
    "depicted_concepts": [
      "Negative Intervention Case",
      "okvqa Dataset",
      "Out-of-Domain Query",
...
"img_attention_functional_roles_27_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-27-0.png",
    "page": 27,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "low",
    "image_type": "other",
    "semantic_role": "decorative",
    "caption": "A bowl of soup and a sandwich on a plate, with no scientific content.",
    "depicted_concepts": [],
    "confidence": "high"
}
```
...
"img_attention_functional_roles_27_2": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-27-2.png",
    "page": 27,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "low",
    "image_type": "other",
    "semantic_role": "decorative",
    "caption": "An outdoor floral clock, constructed with various plants and a central clock mechanism with hands.",
    "depicted_concepts": [],
    "confidence": "high"
}
```
...
"img_attention_functional_roles_27_3": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-27-3.png",
    "page": 27,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "illustrates",
    "caption": "A case study demonstrating a \"Positive Intervention (Success Case)\" in a visual question answering (VQA) task, showing a query, ground truth, original model output, and the improved output after a \"Positive Intervention (High-Level Visual Reception)\". The accompanying photograph depicts a large outdoor clock design on a grassy slope, formed by different colored plants, with clock hands and numerical indicators.",
    "depicted_concepts": [
...
"img_attention_functional_roles_28_1": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-28-1.png",
    "page": 28,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "illustrates",
    "caption": "This diagram presents a \"Positive Intervention Case\" from the MathVista dataset, detailing a visual reasoning query about the maximum value of a function. It displays the query, the ground truth (y=1), an incorrect \"Original Output\" identifying a parabola vertex at (2, 16) with a maximum of 16, and a corrected \"Positive Intervention (Math Reasoning) Output\" stating the highest y-value is y=1, corresponding to the plotted sine-like function.",
    "depicted_concepts": [
...
"img_attention_functional_roles_28_0": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-28-0.png",
    "page": 28,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "plot",
    "semantic_role": "illustrates",
    "caption": "A scatter plot displays a sinusoidal curve, with data points marked by open circles, illustrating a periodic function. The x-axis spans values from approximately -3.1 to 3.1, while the y-axis ranges from -1.0 to 1.0.",
    "depicted_concepts": [
      "Scatter plot",
      "Sinusoidal curve",
      "Periodic function",
...
"img_attention_functional_roles_28_2": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-28-2.png",
    "page": 28,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "low",
    "image_type": "other",
    "semantic_role": "decorative",
    "caption": "An image depicting a toilet and tools on a concrete floor in what appears to be a residential construction or renovation setting.",
    "depicted_concepts": [],
    "confidence": "high"
}
```
...
"img_attention_functional_roles_28_3": {
    "path": "E:/Python Stuff/MAS-for-multimodal-knowledge-graph/markdown_outputs/images/attention_functional_roles.pdf-28-3.png",
    "page": 28,
    "section": "- INVESTIGATING THE FUNCTIONAL ROLES OF ATTEN ### TION HEADS IN VISION LANGUAGE MODELS: EVI DENCE FOR REASONING MODULES",
    "image_relevance": "high",
    "image_type": "diagram",
    "semantic_role": "illustrates",
    "caption": "The image illustrates a 'Positive Intervention Case (Failure Case)' from the OK-VQA (Out-of-Domain) dataset, detailing a visual question answering scenario. It presents a query, its ground truth ('Plumber'), an 'Original Output' referencing 'plumber', and a 'Positive Intervention (High-Level Visual Reception) Output' referencing 'handyman', all in relation to an accompanying photograph. The photograph depicts a bathroom under construction or repair, featuring a toilet with its tank removed, a floor drain, and various tools including a drill, hammer, and screwdriver on the concrete floor.",
    "depicted_concepts": [
      "Positive Intervention Case",
      "Failure Case",
      "OK-VQA Dataset",
