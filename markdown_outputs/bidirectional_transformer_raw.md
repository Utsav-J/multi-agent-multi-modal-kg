...
![](D:/Major Project/multi-agent-multi-modal-kg/markdown_outputs/images/bidirectional_transformer.pdf-2-0.png)
...
ture is a multi-layer bidirectional Transformer encoder based on the original implementation described in Vaswani et al. (2017) and released in
...
_H_, and the number of self-attention heads as _A_ . [3]
...
vector of the special [CLS] token as _C ∈_ R _[H]_,
and the final hidden vector for the _i_ [th] input token
as _Ti ∈_ R _[H]_ .
...
tionships, we pre-train for a binarized _next sen-_
_tence prediction_ task that can be trivially generated from any monolingual corpus. Specifically,
...
in Figure 1, _C_ is used for next sentence prediction (NSP). [5] Despite its simplicity, we demonstrate in Section 5.1 that pre-training towards this
...
![](D:/Major Project/multi-agent-multi-modal-kg/markdown_outputs/images/bidirectional_transformer.pdf-4-0.png)
...
Fine-tuning is straightforward since the selfattention mechanism in the Transformer al
...
as described in Section 3, and use the final hidden vector _C ∈_ R _[H]_ corresponding to the first
input token ([CLS]) as the aggregate representation. The only new parameters introduced during
fine-tuning are classification layer weights _W ∈_
R _[K][×][H]_, where _K_ is the number of labels. We compute a standard classification loss with _C_ and _W_,
i.e., log(softmax( _CW_ _[T]_ )).
...
8
[See (10) in https://gluebenchmark.com/faq.](https://gluebenchmark.com/faq)
...
the B embedding. We only introduce a start vector _S ∈_ R _[H]_ and an end vector _E ∈_ R _[H]_ during
...
_e_ _[S][·][Ti]_
all of the words in the paragraph: _Pi_ = ~~�~~ _j_ _[e][S][·][Tj]_ [.]
...
and the maximum scoring span where _j ≥_ _i_ is
...
Human (expert) _[†]_      - 85.0
Human (5 annotations) _[†]_      - 88.0


Table 4: SWAG Dev and Test accuracies. _[†]_ Human performance is measured with 100 samples, as reported in
the SWAG paper.


ˆ
_si,j_ = `max` _j≥iS·Ti_ + _E·Tj_ . We predict a non-null
answer when ˆ _si,j > s_ `null` + _τ_, where the threshold _τ_ is selected on the dev set to maximize F1.
...
Embeddings 91.0   Second-to-Last Hidden 95.6   
Last Hidden 94.9   Weighted Sum Last Four Hidden 95.9   Concat Last Four Hidden 96.1   Weighted Sum All 12 Layers 95.5   
...
labeling. In _Proceedings of the 27th International_
...
[crosslingual focused evaluation.](https://doi.org/10.18653/v1/S17-2001) In _Proceedings_
_of the 11th International Workshop on Semantic_
_Evaluation (SemEval-2017)_, pages 1–14, Vancouver, Canada. Association for Computational Linguistics.
...
Kevin Clark, Minh-Thang Luong, Christopher D Manning, and Quoc Le. 2018. Semi-supervised sequence modeling with cross-view training. In _Pro-_
_ceedings of the 2018 Conference on Empirical Meth-_
_ods in Natural Language Processing_, pages 1914–
1925.
...
[natural language inference data. In](https://www.aclweb.org/anthology/D17-1070) _Proceedings of_
_the 2017 Conference on Empirical Methods in Nat-_
_ural Language Processing_, pages 670–680, Copenhagen, Denmark. Association for Computational
Linguistics.
...
from unlabelled data. In _Proceedings of the 2016_
_Conference of the North American Chapter of the_
_Association for Computational Linguistics: Human_
_Language Technologies_ . Association for Computational Linguistics.
...
[supervised sentence representation learning.](http://arxiv.org/abs/1705.00557) _CoRR_,
abs/1705.00557.
...
Quoc Le and Tomas Mikolov. 2014. Distributed representations of sentences and documents. In _Inter-_
...
[tations.](https://openreview.net/forum?id=rJvJXZb0W) In _International Conference on Learning_
_Representations_ .


Bryan McCann, James Bradbury, Caiming Xiong, and
Richard Socher. 2017. Learned in translation: Con
textualized word vectors. In _NIPS_ .
...
Tomas Mikolov, Ilya Sutskever, Kai Chen, Greg S Corrado, and Jeff Dean. 2013. Distributed representations of words and phrases and their compositionality. In _Advances in Neural Information Processing_
_Systems 26_, pages 3111–3119. Curran Associates,
Inc.
...
D. Koller, D. Schuurmans, Y. Bengio, and L. Bottou, editors, _Advances in Neural Information Pro-_
_cessing Systems 21_, pages 1081–1088. Curran Associates, Inc.
...
[word representation. In](http://www.aclweb.org/anthology/D14-1162) _Empirical Methods in Nat-_
...
for semantic compositionality over a sentiment treebank. In _Proceedings of the 2013 conference on_
...
_alyzing and Interpreting Neural Networks for NLP_,
pages 353–355.
...
_Long Papers)_ . Association for Computational Linguistics.
...
and reading books. In _Proceedings of the IEEE_
...
![](D:/Major Project/multi-agent-multi-modal-kg/markdown_outputs/images/bidirectional_transformer.pdf-12-0.png)
...
![](D:/Major Project/multi-agent-multi-modal-kg/markdown_outputs/images/bidirectional_transformer.pdf-14-4.png)





![](D:/Major Project/multi-agent-multi-modal-kg/markdown_outputs/images/bidirectional_transformer.pdf-14-0.png)





![](D:/Major Project/multi-agent-multi-modal-kg/markdown_outputs/images/bidirectional_transformer.pdf-14-1.png)
...
![](D:/Major Project/multi-agent-multi-modal-kg/markdown_outputs/images/bidirectional_transformer.pdf-14-2.png)
...
![](D:/Major Project/multi-agent-multi-modal-kg/markdown_outputs/images/bidirectional_transformer.pdf-14-3.png)
